...
public class MotorPH_BasicPayrollSystem {
    ...
    // Valid credentials based on the given flow
    ...
    // Employee menu based on the required flow
    ...
    // Payroll staff main menu based on the required flow
    ...
    // Display payroll records from JJune to December
